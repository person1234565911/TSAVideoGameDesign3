...
if (place_meeting(x, y + player_speed_y, objCollision)) or (place_meeting(x, y + player_speed_y,objOneWay) && one_way_on_top)
{
	player_speed_y = 0;
...
move_and_collide(0, player_speed_y, objCollision, 4, 0, 0, 0, player_max_fall_speed);
